        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="rounded-xl border border-white/10 bg-card/60 p-6 backdrop-blur">
            ...
            <p className="mt-2 text-muted-foreground">
              ...
              develops intuitive modern UIs and developer aids. Fascinated by
              core systems engineering, computational algorithms, and realizing
              prototypes via programming and aesthetics.
            </p>
            <p className="mt-2 text-muted-foreground">
              When not at the keyboard, I craft mind-altering stories and poems,
          ...
          <div className="rounded-xl border border-white/10 bg-card/60 p-6 backdrop-blur">
            ...
            <ul className="mt-3 grid list-disc grid-cols-1 gap-2 pl-5 text-sm sm:grid-cols-2">
              ...
              <li className="text-lime-300 font-semibold">
                Amateur Psychology
              </li>
